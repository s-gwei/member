 ...
 */
@Data
@TableName("consumpt_record")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="consumpt_record对象", description="消费记录表")
public class ConsumptRecord implements Serializable {
    ...
    private java.lang.String consumtWay;
	/**员工id*/
